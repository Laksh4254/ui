...
const Dashboard = () => {
  ...
  return (
    <div class="col main pt-5 mt-3">
      <p class="lead d-none d-sm-block">Hello Shahrukh</p>
       <hr/>
        ...
        <div class="col-xl-3 col-sm-6 py-2">
          <div class="card bg-success text-white h-100">
            <div
              ...
              style={{ backgroundColor: "#57b9" }}
            >
              <div class="rotate">
                
                <i class="fas fa-dollar-sign fa-4x"> </i>
              </div>
              <h6 class="text-uppercase">Earning</h6>
      ...
      <div class="row ">
        ...
        <div className="col-lg-5 col-md-6 col-sm-12 col-sm-offset-5">
          ...
          <div className="mb-5" style={{ height: "300px", width: "00px" }}>
            <PieChart />{" "}
          </div>
        </div>
      </div>
